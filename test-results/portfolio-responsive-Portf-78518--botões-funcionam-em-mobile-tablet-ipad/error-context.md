...
- Name: portfolio-responsive.spec.js >> Portfólio responsivo >> navegação e botões funcionam em mobile
- Location: tests\portfolio-responsive.spec.js:34:3
...
Call log:
  - waiting for getByRole('link', { name: 'Projetos' })
